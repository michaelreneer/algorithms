...
class TestSelectionSort(unittest.TestCase):
  ...
  def test_selection_sort_with_two_items_1(self):
    iterable = [1, 2]
    algorithms.selection_sort(iterable)
    expected = [1, 2]
    self.assertEqual(iterable, expected)
  ...
  def test_selection_sort_with_three_items_1(self):
    iterable = [1, 2, 3]
    algorithms.selection_sort(iterable)
    expected = [1, 2, 3]
    self.assertEqual(iterable, expected)

  def test_selection_sort_with_three_items_2(self):
    iterable = [1, 3, 2]
    algorithms.selection_sort(iterable)
    expected = [1, 2, 3]
    self.assertEqual(iterable, expected)

  def test_selection_sort_with_three_items_3(self):
    iterable = [2, 1, 3]
    algorithms.selection_sort(iterable)
    expected = [1, 2, 3]
    self.assertEqual(iterable, expected)

  def test_selection_sort_with_three_items_4(self):
    iterable = [2, 3, 1]
    algorithms.selection_sort(iterable)
    expected = [1, 2, 3]
    self.assertEqual(iterable, expected)

  def test_selection_sort_with_three_items_5(self):
    iterable = [3, 1, 2]
    algorithms.selection_sort(iterable)
    expected = [1, 2, 3]
    self.assertEqual(iterable, expected)
  ...
  def test_selection_sort_with_ascending_items(self):
  ...
  def test_selection_sort_with_equal_items(self):
